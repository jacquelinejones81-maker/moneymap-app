...
<BudgetApp lead={currentLead} firebaseUser={firebaseUser} onSignOut={handleSignOut} onDeleteAccount={handleDeleteAccount} />  return <LandingPage onSubmit={handleLeadSubmit} repName={repName} />;
}
