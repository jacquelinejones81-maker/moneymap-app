...
export default function LandingPage({ onSubmit }) {
  ...
  const handleGetAccess = function() {
    ...
    setSubmittedLead(Object.assign({}, form, { wantsReview: wantsReview }));
    setShowPopup(true);
  };
        ...
        <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '2rem', alignItems: 'start' }}>
          ...
          <div className="slide-up" style={{ flex: isMobile ? 'none' : '0.9', width: '100%', background: 'var(--navy-card)', border: '1px solid var(--navy-border)', borderRadius: 'var(--radius-xl)', padding: isMobile ? '1.25rem' : '2rem' }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--text-muted)', textAlign: 'center', marginBottom: '1.5rem', lineHeight: 1.6 }}>
              New here? Fill out the form to get started. <strong style={{ color: 'var(--text-secondary)' }}>Already have an account?</strong> Enter your same name, email, and phone to pick up right where you left off — no new sign-up, no duplicate offers.
            </p>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <input type="email" placeholder="your@email.com" value={form.email}
                onChange={function(e) { setForm(function(f) { return Object.assign({}, f, { email: e.target.value }); }); setErrors(function(er) { return Object.assign({}, er, { email: '' }); }); }}
          ...
          <div className="modal-box slide-up" style={{ maxWidth: 540 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: '1.5rem' }}>
              <div style={{ background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 'var(--radius-md)', padding: '12px 16px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--gold)', marginBottom: 3 }}>Check your email at {submittedLead && submittedLead.email}</div>
                  <div style={{ fontSize: 12, color: 'var(--text-secondary)', lineHeight: 1.5 }}>Your free "How Money Works" book is on its way, plus exclusive money tips.</div>
                </div>
              </div>
                ...
                <div style={{ background: 'rgba(14,165,160,0.08)', border: '1px solid rgba(14,165,160,0.35)', borderRadius: 'var(--radius-md)', padding: '16px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: 'var(--text-secondary)', lineHeight: 1.6 }}>Most people retire on someone else's timeline because they never knew their number. We're going to change that for you. In one free session, we'll map out exactly what you need saved, by when, and build a real plan to get you there.</div>
                    </div>
                  </div>
